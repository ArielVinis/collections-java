...
[2] "Java™ Platform, Standard Edition 21 API Specification - Class List." Oracle. Disponível em: https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html.
