...
[2] "Java™ Platform, Standard Edition 21 API Specification - Class Map." Oracle. Disponível em: https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Map.html.
